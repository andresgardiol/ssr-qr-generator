        ...
        <div className="App">
            <Head>
                ...
                <meta property="twitter:image"
                      content={query.text ? `http://localhost:3000/api/image?text=${query.text}` : "https://simple-qr-generator.web.app/logo512.png"}/>

                <meta property="og:image" content="https://simple-qr-generator.web.app/logo512.png"/>
